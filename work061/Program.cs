...
while (j != m || j == 0)                                              // Как сделать проверку правильно? Мне кажется что тут не верно
{
    Console.WriteLine("Число столбцов первой должно соответствовать числу строк второй. Введите корректные данные");
    return;                                                           // Break тут пропускает дальше((
}
...
PrintArray(matrix2);
System.Console.WriteLine();
System.Console.WriteLine("Результат произведения первой и второй матрицы : ");
